package de.vrees.heatpump.ethercat.slaves.beckhoff;
...
public class EL2008 extends Slave {
    ...
    public EL2008(int aliasAddress, int configAddress) {
        ...
        sm(0).registerPDO(out1);
        sm(0).registerPDO(out2);
    ...
    public void setOut1(boolean val) {
        out1.output.set(val);
    }

    public void setOut2(boolean val) {
        out2.output.set(val);
    }
